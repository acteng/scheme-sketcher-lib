import { map as mapStore } from "../config";
...
export function layerId(layerId) {
    return {
        id: layerId,
...
function getBeforeId(layerId) {
    ...
    if (!map) {
        console.warn(`getBeforeId(${layerId}) called before map is ready. Z-ordering may be incorrect.`);
        return undefined;
    }
